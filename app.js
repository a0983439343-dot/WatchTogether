(() => {
  ...
  async function handleGoogleRedirectResult() {
    ...
    try {
      ...
      if (
        ...
        message =
          "目前網站網域尚未加入 Firebase Authentication 授權網域";
      }
  ...
  async function searchYoutube(
    ...
    if (
      ...
      throw new Error(
        "請先把新的 YouTube API Key 放到 app.js"
      );
    }
  ...
  function disconnectSearchObserver() {
    ...
    if (
      ...
      try {
        container.__youtubeObserver.disconnect();
      } catch (_) {}
