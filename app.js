(() => {
   ...
   * 注意：
   * 你之前把 API Key 直接貼出來了。
   * 建議去 Google Cloud Console 重新建立 / 限制這把 Key。
   *
   * 把下面換成你自己的新 Key。
   */
  ...
  async function saveName() {
    ...
    try {
      ...
      try {
        ...
        /*
         * Firebase Rules 暫時沒有允許 members update 時，
         * 不讓整個改名功能直接爆掉。
         */
        console.warn(
          "同步成員名稱失敗:",
