    ...
    try {
      if (
        ...
        try {
          ...
          /*
           * 如果 Google 帳號已經是另一個 Firebase 使用者，
           * 改成正常 Google 登入。
           */
        }
      }
      ...
      if (
        ...
        toast(
          "先到 Firebase Authentication → 設定 → Authorized domains 加入你的 GitHub Pages 網域"
        );
