(() => {
  ...
  const state = {
    ...
    youtubeBuildId: null,
    youtubeBuildToken: null,
    youtubeBuilding: false,
  ...
  async function buildYoutubePlayer(
    ...
    if (
      state.youtubeBuilding &&
      state.youtubeBuildId ===
        videoId
    ) {
      return;
    }
