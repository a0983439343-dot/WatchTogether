(() => {
  ...
  async function shareRoom() {
    ...
    const title =
      state.room?.name
        ? `加入 WatchTogether：${state.room.name}`
        : "加入 WatchTogether 房間";
