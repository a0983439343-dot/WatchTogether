(() => {
   ...
   * =========================================================
   *
   * 把這裡換成你自己的 YouTube Data API v3 Key。
   */
  ...
  /*
   * =========================================================
   * FIXED MEMBER NAME UPDATE
   * =========================================================
   *
   * 這裡就是修正 PERMISSION_DENIED 的主要地方。
   *
   * 如果 members/<uid> 已存在：
   *   update()
   *
  ...
  async function enterRoom() {
    ...
    /*
     * FIX：
     * Google UID 改變後不再用不完整 update，
     * 直接安全建立自己的 members 節點。
     */
    await updateCurrentMemberName();
